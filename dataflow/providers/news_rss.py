...
MORNING_BRIEF_QUERIES = [
    ...
    (
        "fin_banks",
        "bank earnings financial sector JPMorgan Goldman Sachs Morgan Stanley",
    ),
    (
        "fin_fintech",
        "fintech payment blockchain stablecoin digital currency regulation",
    ),
    ("fin_insurance", "insurance underwriting claims climate risk reinsurance"),
    (
        "fin_real_estate",
        "real estate housing market mortgage rates commercial property REIT",
    ),
    # ── Sector: Energy & Commodities (6) ──
    ("energy_oil", "crude oil OPEC shale production refining gasoline price"),
    (
        "energy_renewable",
        "solar wind renewable energy clean power grid battery storage",
    ),
    ...
    (
        "health_biotech",
        "biotech gene therapy CRISPR mRNA precision medicine immunology",
    ),
    ...
    (
        "indus_transport",
        "airlines shipping logistics freight trucking railroad aviation",
    ),
    (
        "indus_construction",
        "construction infrastructure building materials engineering",
    ),
    (
        "indus_manufacturing",
        "manufacturing factory automation robotics reshoring supply chain",
    ),
    # ── Fixed Income & FX (4) ──
    ("bond_treasury", "US Treasury bond yield curve auction debt market"),
    (
        "bond_corporate",
        "corporate bond credit spread investment grade junk default risk",
    ),
    ("fx_dollar", "US dollar DXY foreign exchange currency war forex intervention"),
    (
        "fx_emerging",
        "emerging market currency yuan rupee real peso devaluation outflow",
    ),
    ...
    (
        "corp_earnings",
        "earnings report quarterly results revenue profit guidance beat miss",
    ),
    ("corp_ipo", "IPO listing direct SPAC stock exchange NYSE Nasdaq offering"),
    (
        "corp_ma",
        "merger acquisition takeover buyout antitrust regulatory approval deal",
    ),
    (
        "corp_buyback",
        "stock buyback dividend shareholder activist investor return capital",
    ),
]
