...
class ApproveRequest:
    """Dummy holder; we accept raw dict to avoid strict schema coupling."""
...
def modify_approval(
    ...
    modified_action = body.get("modified_action")
    modified_pct = body.get("modified_target_position_pct")
    ...
    decision = ApprovalDecision(
        ...
        modified_target_position_pct=modified_pct,
        decided_at=datetime.now(timezone.utc),
    )
