...
_EmitterType = Callable[[str, int | None, int | None, str], None]
...
class HeartbeatTimer:
    ...
    def __init__(self, tool_name: str, interval: float = 3.0,
                 emit: _EmitterType | None = None):
    ...
    def _run(self):
        while not self._stop.wait(self._interval):
            ...
            if self._emit:
                try:
                    self._emit(stage="heartbeat", current=None, total=None,
